...
class Pipeline(pipeline.Pipeline):
    ...
    >>> from imbens.pipeline import Pipeline # doctest: +NORMALIZE_WHITESPACE
...
def make_pipeline(*steps, memory=None, verbose=False):
    ...
    *steps : list of estimators
    ...
    See Also
    --------
    imbens.pipeline.Pipeline : Class for creating a pipeline of
...
if __name__ == "__main__":  # pragma: no cover
    ...
    from imbens.sampler import _over_sampling as os
