...
def sensitivity_specificity_support(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from imbalanced_ensemble.metrics import sensitivity_specificity_support
...
def specificity_score(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from imbalanced_ensemble.metrics import specificity_score
    >>> y_true = [0, 1, 2, 0, 1, 2]
    >>> y_pred = [0, 2, 1, 0, 0, 1]
...
def make_index_balanced_accuracy(*, alpha=0.1, squared=True):
    ...
    Examples
    --------
    >>> from imbalanced_ensemble.metrics import geometric_mean_score as gmean
    >>> from imbalanced_ensemble.metrics import make_index_balanced_accuracy as iba
