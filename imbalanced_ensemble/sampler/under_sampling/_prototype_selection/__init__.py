"""
The :mod:`imbalanced_ensemble.sampler.under_sampling.prototype_selection` 
submodule contains methods that select samples in order to balance the dataset.
"""
...
from ._balance_cascade_under_sampler import BalanceCascadeUnderSampler
